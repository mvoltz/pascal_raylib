...
begin
   ...
   fxWav := LoadSound('/home/mark/gits/Ray4Laz/binary/resources/sound/sound.wav');         // Load WAV audio file
   fxOgg := LoadSound('/home/mark/gits/Ray4Laz/binary/resources/sound/tanatana.ogg');        // Load OGG audio file
