...
begin
  ...
  imMap := LoadImage('/home/mark/gits/Ray4Laz/binary/resources/textures/cubicmap.png');      // Load cubicmap image (RAM)
  ...
  texture := LoadTexture('/home/mark/gits/Ray4Laz/binary/resources/textures/cubicmap_atlas.png');          // Load map texture
